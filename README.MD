...
This program enables you to perform large/computationally intensive jobs on a PBS (Portable Batch System) Computing Cluster directly out of Matlab. Some cluster providers do not support the Matlab integration of the MATLAB Parallel Server (formally Distributed Computing Server), e.g. due to license costs.
...
5. Start your job by executing `jobStart.m`. Make a note of the job ID you have been given.
